	...
	public function __construct () {
		...
		$this->checkout_fields['order']	= array(
			'order_comments' => array(
				'type' => 'textarea',
				'class' => array('notes'),
				'label' => __( 'Add a short message for the recipient', 'woocommerce' ),
				'placeholder' => _x('Add a short message for the recipient and we will prepare a handwritten card for you. Please include any details about your order, eg. special delivery instructions.', 'placeholder', 'woocommerce')
			)
		);
